    ...
    const features = [
        {
            ...
            icon: <ListChecks className="w-14 h-14 text-[#DDF4E7]" />
        },
        {
            ...
            icon: <Target className="w-14 h-14 text-[#DDF4E7]" />
        },
        {
            ...
            icon: <MessageCircle className="w-14 h-14 text-[#DDF4E7]" />
        }
    ];
    ...
    return (
        <section className="py-16 bg-[#F4F7F7] font-[Poppins]">
            <div className="container mx-auto px-4 text-center">
                <h2 className="text-4xl md:text-5xl font-extrabold text-[#26667F] mb-4 font-[Outfit]">
                    Apa yang Membuat Kami Berbeda?
                </h2>
                <hr
                    className="w-[89px] h-[5px] mx-auto mt-4 mb-4 border-none rounded-full"
                    style={{ background: 'linear-gradient(to right, #67C090, #26667F)' }}
                />
                <p className="text-lg md:text-xl text-[#26667F] mb-26">
                ...
                <div className="relative pb-20">
                    ...
                    <div className="absolute -top-16 left-4">
                        <img src="/bullet25.svg" alt="bullet" className="w-24 h-24" />
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 px-4 md:px-0 justify-items-center">
                        {features.map((feature, index) => (
                            <div
                                key={index}
                                className="relative p-8 rounded-3xl shadow-lg w-[381px] h-[385px] flex flex-col justify-center text-left"
                                style={{ background: 'linear-gradient(to bottom right, #26667F, #124170)' }}
                            >
                                <div className="mb-4">{feature.icon}</div>
                                <h3 className="text-[#DDF4E7] text-xl font-semibold mb-3">{feature.title}</h3>
                                <p className="text-[#DDF4E7] text-base leading-relaxed">{feature.description}</p>
                            </div>
